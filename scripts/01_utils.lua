-- _G is a global namespace table, its fields can also be accessed without _G prefix ("_G.utils" == "utils")
_G.utils = {
    --[[
    ...
    syncRandFloat = function()
        return systems.GameStateSystem:randomFloat()
    end,

    syncRandInt = function(maxExcl)
        return systems.GameStateSystem:randomInt(maxExcl)
    end
}